package com.isb.gateway.repository;

import com.isb.gateway.GatewayApp;
import com.isb.gateway.config.Constants;
import com.isb.gateway.config.audit.AuditEventConverter;
import com.isb.gateway.domain.PersistentAuditEvent;
...
import static com.isb.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
